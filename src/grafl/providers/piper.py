...
class PiperTTSProvider(TTSProvider):
    ...
    def validate_config(self) -> bool:
        ...
        return self.piper_bin.exists() and self.model_path.with_suffix('.onnx').exists()
    ...
    def speak(self, text: str) -> None:
        ...
        try:
            ...
            # Send text to piper and read audio output
            piper_process.stdin.write(text.encode('utf-8'))
            piper_process.stdin.close()
            
            audio_bytes = piper_process.stdout.read()  # Raw PCM: 16-bit signed LE, mono
